...
class BrandProduct extends Controller
{
    ...
    public function all_brand_product (){
        $this->AuthenLogin();
        $all_brand_product = DB::table('pdh_brand_product')->paginate(5);
    ...
    public function save_brand_product (AddBrandRequests $request){
        ...
        DB::table('pdh_brand_product')->insert($data);
    ...
    public function unactive_brand_product ($brand_product_id){
        $this->AuthenLogin();
        DB::table('pdh_brand_product')->where('brand_id',$brand_product_id)->update(['brand_status'=>1]);
        Session::put('message','Hiện Thương Hiệu Thành Công');
        return Redirect::to('all-brand-product');
    }
    public function active_brand_product ($brand_product_id){
        $this->AuthenLogin();
        DB::table('pdh_brand_product')->where('brand_id',$brand_product_id)->update(['brand_status'=>0]);
    ...
    public function edit_brand_product($brand_product_id){
        $this->AuthenLogin();
        $edit_brand_product = DB::table('pdh_brand_product')->where('brand_id',$brand_product_id)->get();
    ...
    public function update_brand_product(AddBrandRequests $request,$brand_product_id){
        ...
        $data ['brand_slug'] = $request->brand_slug;
        $data ['brand_desc'] = $request->brand_product_desc;
        DB::table('pdh_brand_product')->where('brand_id',$brand_product_id)->update($data);
    ...
    public function delete_brand_product($brand_product_id){
        $this->AuthenLogin();
        DB::table('pdh_brand_product')->where('brand_id',$brand_product_id)->delete();
    ...
    public function show_brand_home(Request $request, $brand_slug){
       ...
       $brand_by_id = DB::table('pdh_product')->join('pdh_brand_product','pdh_product.brand_id','=','pdh_brand_product.brand_id')->where('pdh_brand_product.brand_slug',$brand_slug)->get();
       
       //xô thương hiệu
       $brand_name = DB::table('pdh_brand_product')->where('pdh_brand_product.brand_slug',$brand_slug)->limit(1)->get();
