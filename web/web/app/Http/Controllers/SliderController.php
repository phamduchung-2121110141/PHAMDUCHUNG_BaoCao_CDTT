...
class SliderController extends Controller
{
   public function AuthenLogin(){
    ...
    public function unactive_slider($slider_id){
        $this->AuthenLogin();
        DB::table('pdh_slider')->where('slider_id',$slider_id)->update(['slider_status'=>1]);
    ...
    public function active_slider($slider_id){
        $this->AuthenLogin();
        DB::table('pdh_slider')->where('slider_id',$slider_id)->update(['slider_status'=>0]);
    ...
    public function unactive_ads($ads_id){
        $this->AuthenLogin();
        DB::table('pdh_ads')->where('ads_id',$ads_id)->update(['ads_status'=>1]);
        Session::put('message','kích hoạt  thành công');
    ...
    public function active_ads($ads_id){
        $this->AuthenLogin();
        DB::table('pdh_ads')->where('ads_id',$ads_id)->update(['ads_status'=>0]);
        Session::put('message','Ẩn thành công');
        return Redirect::to('all-ads');
