...
class CategoryProduct extends Controller
{
   ...
   public function AuthenLogin(){
    ...
    public function all_category_product (){
        $this->AuthenLogin();
        $all_category_product = DB::table('pdh_category_product')->paginate(5);
    ...
    public function save_category_product (AddCategoryRequests $request){
        ...
        DB::table('pdh_category_product')->insert($data);
    ...
    public function unactive_category_product ($category_product_id){
        $this->AuthenLogin();
        DB::table('pdh_category_product')->where('category_id',$category_product_id)->update(['category_status'=>1]);
        Session::put('message','Hiện Danh Mục Thành Công');
        return Redirect::to('all-category-product');
    }
    public function active_category_product ($category_product_id){
        $this->AuthenLogin();
        DB::table('pdh_category_product')->where('category_id',$category_product_id)->update(['category_status'=>0]);
    ...
    public function edit_category_product($category_product_id){
        $this->AuthenLogin();
        $edit_category_product = DB::table('pdh_category_product')->where('category_id',$category_product_id)->get();
    ...
    public function update_category_product(AddCategoryRequests $request,$category_product_id){
        ...
        $data ['category_desc'] = $request->category_product_desc;
        $data ['category_slug'] = $request->category_slug;
        DB::table('pdh_category_product')->where('category_id',$category_product_id)->update($data);
    ...
    public function delete_category_product($category_product_id){
        $this->AuthenLogin();
        DB::table('pdh_category_product')->where('category_id',$category_product_id)->delete();
    ...
    //End function Admin Page
     public function show_category_home(Request $request ,$category_slug){
        ...
        $category_by_id = DB::table('pdh_product')->join('pdh_category_product','pdh_product.category_id','=','pdh_category_product.category_id')->where('pdh_category_product.category_slug',$category_slug)->get();
        //xô tên danh mục
        $category_name = DB::table('pdh_category_product')->where('pdh_category_product.category_slug',$category_slug)->limit(1)->get();
