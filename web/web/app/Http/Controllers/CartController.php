...
// Coupon
    ...
    public function edit_coupon($coupon_id){
        $this->AuthenLogin();
        $edit_coupon = DB::table('pdh_coupon')->where('coupon_id',$coupon_id)->get();
    ...
    public function update_coupon(AddCouponRequests $request,$coupon_id){
        ...
        DB::table('pdh_coupon')->where('coupon_id',$coupon_id)->update($data);
        Session::put('message','Cập nhập mã giảm giá thành công');
        return Redirect::to('all-coupon');
    }
    public function delete_coupon($coupon_id){
        $this->AuthenLogin();
        DB::table('pdh_coupon')->where('coupon_id',$coupon_id)->delete();
